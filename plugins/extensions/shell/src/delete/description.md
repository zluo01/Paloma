...
- macos: entries are trashed through the system API, silently and without any permission prompt; the user restores them by dragging out of the Trash (Finder's "Put Back" may be unavailable for them).
