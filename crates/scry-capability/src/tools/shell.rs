...
use super::process_manager::{ProcessExecRequest, ProcessManagerClient};
...
impl Tool for Shell {
    ...
    const DESCRIPTION: &'static str = r#"Executes a command and returns its stdout, stderr, and exit code.
